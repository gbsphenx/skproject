...
extern const __int16 glbXAxisDelta[4];
extern const __int16 glbYAxisDelta[4];
extern const Bit16u glbActivationItemRangePerDB[16];
extern const Bit16u _4976_49c0[];
extern const char ItemCommandsTable[18][3];
extern const __int8  _4976_3fc2[4];
extern const __int16 _4976_3fb8[5];
...
#define READ_I8(PTR,DELTA) *((__int8 *)(PTR_PADD(PTR,DELTA)))
#define READ_I16(PTR,DELTA) *((__int16 *)(PTR_PADD(PTR,DELTA)))
#define READ_I32(PTR,DELTA) *((__int32 *)(PTR_PADD(PTR,DELTA)))
...
#define WRITE_I8(PTR,DELTA,VAL) *((__int8 *)(PTR_PADD(PTR,DELTA))) = (VAL);
#define WRITE_I16(PTR,DELTA,VAL) *((__int16 *)(PTR_PADD(PTR,DELTA))) = (VAL);
#define WRITE_I32(PTR,DELTA,VAL) *((__int32 *)(PTR_PADD(PTR,DELTA))) = (VAL);
