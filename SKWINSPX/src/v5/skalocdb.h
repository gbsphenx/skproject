...
//C++98 note: can't do friend + static
    ...
    friend __WIN_STATIC void DM2_LOAD_ENT1(void);
    friend __WIN_STATIC void DM2_LOAD_GDAT_ENTRIES(void);
    friend __WIN_STATIC void DM2_BUILD_GDAT_ENTRY_DATA(s_1e09e0* eaxp_s81, unk* xebxp);
    friend void DM2_FREE_PICT_ENTRY(c_pixel* gfx);
    friend __WIN_STATIC i32 DM2_QUERY_GDAT_ENTRY_VALUE(i16 eaxw, i16 edxw);
    friend void DM2_LOAD_GDAT_RAW_DATA(t_dbidx dbidx, unk* xedxp);
    friend __WIN_STATIC i32 DM2_QUERY_GDAT_RAW_DATA_FILE_POS(t_dbidx dbidx);
  };
