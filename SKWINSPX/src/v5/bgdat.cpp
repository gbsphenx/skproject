...
{
//SPX_DEBUG_PRINT_WAIT("DM2_GRAPHICS_DATA_OPEN (filecounter = %d)\n", gdat.fileopencounter);
...
__WIN_STATIC i32 DM2_QUERY_GDAT_RAW_DATA_FILE_POS(t_dbidx dbidx)
{
...
__WIN_STATIC i32 DM2_QUERY_GDAT_ENTRY_VALUE(i16 eaxw, i16 edxw)
{
...
__WIN_STATIC void DM2_BUILD_GDAT_ENTRY_DATA(s_1e09e0* eaxp_s81, unk* xebxp)
{
  i32 longrg6;
  i32 vl_04;
  c_ql32 vql_0c;
  ...
  for (vb_1c = bcon(0x0); (longrg41 = mkl(unsignedlong(vb_1c))) <= (longrg5 = unsignedlong(eaxp_s81->entries)); vb_1c++)
  {
    ...
    for (i8 byterg4 = bcon(0x0); mkul(longrg5 = mkl(unsignedlong(byterg4))) < (ui32) mkl(unsignedlong(vol_18.peek16())); byterg4++)
    {
...
__WIN_STATIC void DM2_LOAD_GDAT_ENTRIES(void)
{
  ui16 uwordrg5 = 0;
...
__WIN_STATIC void DM2_LOAD_ENT1(void)
{
...
void DM2_READ_GRAPHICS_STRUCTURE(void)
{
  ...
  printf("DM2_GRAPHICS_DATA_OPEN done\n");
