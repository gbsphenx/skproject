...
{
	SPX_DEBUG_PRINT("STRINGDATA:INIT\n");
  i16 i = 0;
  for (i = 0; i < 5; i++)
...
t_text internal_Z008DataFolder[256];
  ...
  for (;;)
  {
    ...
    *RG4t = '\0';
    ...
    switch (option)
    {
      ...
      case 2:
        //m_2A920:
        RG6t = ddat.v1d675a;	// hodling ".Z008DATA\"
		if (ddat.datafoldername != NULL) {
			sprintf(internal_Z008DataFolder, ".Z008%s", ddat.datafoldername);
			RG6t = (t_text*) internal_Z008DataFolder;
		}
