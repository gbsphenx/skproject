...
i32 DM2_GET_CREATURE_ANIMATION_FRAME(i32 eaxl, i32 edxl, i16* ebxpw, i16* ecxpw, unk** argpp0, i32 argl1)
{
  ...
  RG1P = DM2_QUERY_GDAT_ENTRY_DATA_PTR(GDAT_CATEGORY_x0F_CREATURES, RG4Blo, dtRaw8, lcon(GDAT_CREATURE_ANIM_ATTRIBUTION));
#ifndef __LINUX__
  ...
  RG1P = DM2_QUERY_GDAT_ENTRY_DATA_PTR(GDAT_CATEGORY_x0F_CREATURES, RG4Blo, dtRaw7, lcon(GDAT_CREATURE_ANIM_INFO_SEQUENCE));
  RG2P = RG1P;
