...
i16 table1d27fc[4] =
{
  0x0000, 0x0001, 0x0000, -1
};

i16 table1d2804[4] =
{
  -1, 0x0000, 0x0001, 0x0000
};
...
U8 tblMusicsMap[64] = // real size? number of levels!
{
...
// SPX possibly X delta/dir ?
const i8 table1d3ffc[4] =
{
  0, 1, 0, -1
};

// SPX possibly Y delta/dir ?
...
const U8 table1d6c5e[9] = { 0x99, 0x9a, 0x9a, 0x9c, 0x9d, 0x9d, 0x9f, 0xa0, 0xa0 };
const i8 table1d6c67[9] = { 0x00, 0x00, 0x01, 0x00, 0x00, 0x01, 0x00, 0x00, 0x01 };

const U8 table1d6c06[5] =
{
...
const U16 table1d6998[5] = { 0xfffe, 0xfffd, 0x0000, 0xffff, 0xfffe };
const U8 table1d6984[20] =
{
...
const U8 table1d6d76[2][4] =
{
  0xff, 0x01, 0x01, 0xff,
  0x00, 0x01, 0x00, 0xff
};

const U8 table1d6d7e[2][4] =
{
  0x01, 0x01, 0xff, 0xff,
  0x02, 0x00, 0xfe, 0x00
};
...
void c_dm2data::init(void)
{
  ...
  i16 j = 0;
//--- some tables first
  DM2_READ_BINARY((t_text*)"bin/v5/v1d39bc.dat", v1d39bc, 0x1e4);
  DM2_READ_BINARY((t_text*)"bin/v5/v1d338c.dat", v1d338c, sizeof(v1d338c));
  DM2_READ_BINARY((t_text*)"bin/v5/v1d6802.dat", table1d6802, 0x110); 
  DM2_READ_BINARY((t_text*)"bin/v5/v1d296c.dat", table1d296c, 0x3f * 0x24);
...
*/
  ...
  savegamel1 = 0;
  savegamel2 = false;
  savegamew4 = (i16)0xFFFF;	// 0xffffffff
  savegamew6 = 0;
  savegamep1 = NULL;
  savegamew7 = 0;
  ...
  DM2_READ_BINARY((t_text*)"bin/v5/v1d7108.dat", v1d7108, 0x80);
  ...
  DM2_READ_BINARY((t_text*)"bin/v5/v1d653c.dat", v1d653c, 0x37 * 8);
