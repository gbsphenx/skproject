//==============================================================================
//--- SkWinCore-EDIT DUNGEON----------------------------------------------------
//SPX: This part of code contains:
// - Dungeon Basic Manipulation
//
// This is new code for making easier dungeon/map manipulation
//------------------------------------------------------------------------------
//==============================================================================
...
ObjectID SkWinCore::DUNGEON_PUT_NEW_DOOR(int iDoorType, int iMapIndex, int iPosX, int iPosY)
{
...
void SkWinCore::DUNGEON_PUT_PARTY_SPIN_180(int iMapIndex, int iPosX, int iPosY)
{
	;
}
