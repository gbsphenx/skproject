...
void SkWinCore::_2fcf_0b8b(Bit16u xx, Bit16u yy, Bit16u zz)
{
	...
	if (_4976_4c08 != 0) {
		...
		glbDir_4976_4c10 = (glbPlayerDir + (bp06.cross_scene_test_of_teleporter_target() - bp06.cross_scene_test())) & 3;
	}
	else {
		//^2FCF:0BE6
		for (Bit16u si = 0; si < 4; si++) {
			...
			if (GET_TELEPORTER_DETAIL(&bp06, xx + glbXAxisDelta[si], yy + glbYAxisDelta[si]) != 0) {
				...
				//^2FCF:0C57
				glbDir_4976_4c10 = (glbPlayerDir + di) & 3;
				//^2FCF:0C62
				break;
			}
			//^2FCF:0C64
...
Bit16u SkWinCore::QUERY_STR_METRICS_U16(Bit8u *buff, Bit16u *xx, Bit16u *yy)
{
...
//^098D:116D
Bit8u *SkWinCore::ALLOC_UPPER_MEMORY(U32 size)
{
	// TODO: 本ズレ函数
	//^098D:116D
	//^098D:1170
...
//^3E74:0683
Bit8u *SkWinCore::FIND_FREE_POOL(U32 size, Bit16u poolno)
{
	//^3E74:0683
	Bit16u si = poolno;
	//^3E74:068B
