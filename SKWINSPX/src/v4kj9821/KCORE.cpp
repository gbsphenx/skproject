...
Bit16u SkWinCore::QUERY_CMDSTR_TEXT(const Bit8u *cmdStr, const Bit8u *name)
{
	...
	// for example, returns 0 if you query "WH" for "ÚÉ:CM4SK4BZ2TR3TA-2EX5PB38DM40".

	// cmdStr: e.g. "ÚÉ:CM4SK4BZ2TR3TA-2EX5PB38DM40".
	// name: e.g. "WH"
...
void SkWinCore::DRAW_VP_STR(Bit16u dstx, Bit16u dsty, Bit16u clr1, const Bit8u *str)
{
	...
	// a) version: "V1.0"
	// b) button text: "A6 86 97 A8" [ƒ[ƒgJ] (=load), "8B 84 A7 92 A5" [ƒLƒƒƒ“ƒZƒ‹] (=cancel)
