...
namespace DMEncyclopaedia {
	...
	struct ObjectID {
		...
		static ObjectID Raw32(U32 w32) { ObjectID rl; rl.w = (w32 & 0xFFFF); return rl; };
	};
...
#define OID_MASK_ID			0xFFFF
	...
	struct Door_Info
	{
		...
		unsigned short verticalOpening:1;
...
/* -- replace this by sksave_header_asc
	struct sksave_header { // 42 bytes
		Bit16u bp4c;	// bp4c, usually 1
		Bit8u  sSavegameName[34];	// bp4a
		Bit16u bp26;	// bp26
		Bit16u bp24;	// bp24
		Bit16u bp22;	// bp22
	};
*/
	...
	struct sksave_header_asc { // 42 bytes
		Bit16u wTimerFlag;		// w0
		Bit8u  sSavegameName[34];	// b2
		Bit16u w36;		// w36
		Bit16u w38;		// w38
		Bit16u w40;		// w40
	};
