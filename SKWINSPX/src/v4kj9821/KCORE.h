...
//
	...
	U16		_4976_4c40;	// dir?
	U8		_4976_4c42[16];
	OID_T	*_4976_4c52;			// Bit16u* [LOCAL] Index of tiles with objects on them (per column)
...
#define SIZE_LOCAL_CREATURE_VAR (reinterpret_cast<const U8 *>(&glbCreatureTempTargetX) - reinterpret_cast<const U8 *>(&glbCurrentThinkingCreatureID))
	...
	Bit16u	glbSKSaveNum;				// (_4976_525c) SKSave num when selected from resume screen
...
// SPX: New procedures here
	...
	const X8* GET_DATA_FOLDER_NAME(i16 predefinedGameID);
	...
	Bit8u GET_CHAMPION_BONES_ITEM_ID();
	...
	void DUNGEON_PUT_NEW_DOOR(int iDoorType, int iMapIndex, int iPosX, int iPosY);
...
protected:
	...
	Bit16u ADD_ITEM_CHARGE(ObjectID recordLink, i16 delta);
	...
	void _01b0_0adb();
	void IBMIO_SET_CURSOR_PATTERN(	i16 index, 	Bit8u *buffSrc, 	Bit8u zz, 	Bit8u ss, 	Bit16u srcWidth, 	Bit16u srcHeight,	Bit16u srcBits, 	Bit8u *localPal, 	Bit16u colorkey);
	...
	U16 IS_MISSILE_VALID_TO_LAUNCHER(Bit16u player, i16 hand, ObjectID rlWhatYouLaunch);
	...
	void LOAD_PROJECTILE_TO_HAND(Bit16u player, i16 hand);
	...
	void _0b36_11c0(ExtendedPicture *xx, sk3f6c *yy, Bit16u ss, i16 colorkey2);
	...
	void DRAW_ICON_PICT_ENTRY(Bit8u cls1, Bit8u cls2, Bit8u cls4, sk3f6c *ss, Bit16u rectno, i16 colorkey);
	...
	void FIRE_BLIT_TO_MEMORY_ROW_4TO8BPP(Bit16u offSrc, Bit16u offDst, Bit16u width, i16 colorkey);
	...
	Bit16u QUERY_PLAYER_SKILL_LV(i16 player, Bit16u skill, Bit16u yy);
	Bit16u IS_ITEM_HAND_ACTIVABLE(Bit16u player, ObjectID recordLink, i16 yy);
	...
	Bit16u _19f0_124b(i16 *xx, i16 *yy, Bit16u ww, i16 ss, Bit16u tt);
	...
	Bit16u GET_RANDOM_ORNAMENT_INDEX(Bit16u iValue1, Bit16u iValue2, Bit16u iModulo); // _0cee_17e7 renamed GET_RANDOM_ORNAMENT_INDEX
	Bit8u GET_RANDOM_ORNAMENT_ORDINAL(i16 xx, i16 yy, Bit16u ss, Bit16u tt, Bit16u uu); // _0cee_1815 renamed GET_RANDOM_ORNAMENT_ORDINAL
	void SET_SQUARE_ASPECT_RANDOM_WALL_ORNAMENT_ORDINALS(ExtendedTileInfo *ref, Bit16u xx, Bit16u yy, Bit16u zz, Bit16u ww, Bit16u vv, i16 ss, i16 tt); // _0cee_185a renamed SET_SQUARE_ASPECT_RANDOM_WALL_ORNAMENT_ORDINALS
	...
	void SHOW_CREDITS();
	U8 SK_IMPORTB(U16 port);	// importb
...
//	void _sk_longjmp(jmp_buf xx, Bit16u yy);
	...
	Bit16u QUERY_STR_METRICS(const Bit8u *buff, i16 *xx, i16 *yy);
	inline Bit16u QUERY_STR_METRICS(Bit8u *buff, Bit16u *xx, Bit16u *yy);	// INLINE
	Bit16u _3929_04e2_DRAW_TEXT_STRINGS(const Bit8u *strIn, Bit8u *strOut, Bit16u *textPos, i16 maxWidth); // _3929_04e2
	const Bit8u *DRAW_MBCS_STR(const Bit8u *str,	Bit8u *dst, 	i16 zz, 	Bit8u *ww, 	Bit16u clr1, 	Bit16u clr2, 	Bit16u *xx, 	Bit16u *yy, 	Bit16u dstpitch, 	Bit16u dstbpp);
	...
	void _0aaf_002f();
	Bit16u max_value(i16 v1, i16 v2);
	Bit16u min_value(i16 v1, i16 v2);
	...
	void QUERY_TOPLEFT_OF_RECT(Bit16u rectno, i16 *xpos, i16 *ypos);
	...
	i16 GET_PLAYER_AT_POSITION(Bit16u position);
	...
	void __DECLSPEC_NORETURN_ RAISE_SYSERR(Bit16u syserr);
	...
	void IBMIO_BLIT_MOUSE_CURSOR(Bit8u *buff, SRECT *rc, Bit16u srcx, Bit16u srcy, Bit16u srcpitch, i16 colorkey);
	void _01b0_05ae();
	...
	int READ_RECORD_CHECKCODE(i16 xpos, i16 ypos, ObjectID *recordLinkPtr, Bit16u readDir, Bit16u readSub);
	...
	Bit16u IBMIO_SBLASTER_BLEND_TO_SNDBUFF(Bit8u *buff, Bit16u buffSize, i8 volume, Bit16u caller);
	...
	void QUEUE_NOISE_GEN2(Bit8u cls1, Bit8u cls2, Bit8u cls4, Bit8u cls2alt, i16 xpos, i16 ypos, Bit16u tickDelta, Bit8u ss, Bit8u tt);
	void DELETE_TIMER(Bit16u xx);
	void INVOKE_MESSAGE(i16 xpos, i16 ypos, Bit16u dir, Bit16u actionType, Bit32u tick);
	...
	void PLACE_OR_REMOVE_OBJECT_IN_ROOM(i16 xpos, i16 ypos, ObjectID recordLink, Bit16u ss, Bit16u place, Bit16u uu); // _2fcf_2444
	void DELETE_CREATURE_RECORD(i16 xpos, i16 ypos, Bit16u dropMode, Bit16u tt);
	void DROP_CREATURE_POSSESSION(ObjectID recordLink, i16 xx, i16 yy, Bit16u dropMode, i16 tt);
	...
	Bit16u _2fcf_0434(ObjectID recordLink, i16 xpos, i16 ypos, i16 xx, i16 yy, Bit16u zz);	// big funct
	ObjectID _1c9a_03cf(i16 *xx, i16 *yy, Bit16u dir);
	i16 ABS16(i16 val);
	...
	Bit16u MOVE_RECORD_TO(ObjectID rlWhatYouMove, i16 xposFrom, i16 yposFrom, i16 xposTo, i16 yposTo);
