...
#ifndef _SKWIN_INPUT_H_
#define _SKWIN_INPUT_H_
...
// This class remains here just for CSkWinMFC usage; it might be dropped when everything is separated
class CSkWin {
public:
