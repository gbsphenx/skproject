...
// NOTE: that may need to be moved
...
extern const X8 * const _4976_395a;
extern const X8 * const _4976_3956;
extern const X8 * const _4976_3992;
extern const X8 * const _4976_3a97;
extern const X8 * const _4976_3a9d;
extern const X8 * const strZT_EndOfString;
extern const X8 * const strZT_F;
extern const X8 * const strZT_G;
extern const X8 * const strZT_strData1;
extern const X8 * const strZT_strData2;
extern const X8 * const strZT_strData3;
extern const X8 * const strZT_strData4;
extern const X8 * const strZT_strData5;
extern const X8 * const strZxxxTable[];
extern const X8 * const strSKSave_dat;
extern const X8 * const strSKSave_bak;
extern const X8 * const strDungeon_ftl;
extern const X8 * const strGraphics;
extern const X8 * const strGraphics2;
extern const X8 * const _4976_3b68;
extern const X8 * const _4976_4853;
extern const X8 * const _4976_485a;
extern const X8 * const strPC286Required;
extern const X8 * const _04bf_067a;
extern const X8 * const strDungenB;
extern const X8 * const strDungeon;
extern const X8 * const strVersionNumber;
extern const X8 * const strSlash;
extern char strDirLetter[3];
extern char strDirLetter2[3];
//}}SKSTRTBL

//{{SKSTRREF
extern const X8 * const ptrDirLetter;
extern const X8 * const ptrDirLetter2;
extern const X8 * const ptrDungenB;
extern const X8 * const ptrSKSave_dat;
extern const X8 * const ptrSKSave_bak;
extern const X8 * const ptrDungeon_ftl;
extern const X8 * const ptrGraphics;
extern const X8 * const ptrGraphics2;
extern const X8 * const ptrDungeonFilename;
//}}SKSTRREF
...
extern const X8 glbItemSizePerDB[16];
extern const X8 glbByte01[1];
extern const X8 glbGDAT2CatPerDB[16];
extern const X8 _4976_0c5e[0x2c];
extern const i16 glbXAxisDelta[4];
extern const i16 glbYAxisDelta[4];
extern const U16 glbActivationItemRangePerDB[16];
extern const U16 _4976_49c0[];
extern const char ItemCommandsTable[18][3];
extern const i8  _4976_3fc2[4];
extern const i16 _4976_3fb8[5];
extern const X8 _4976_3fa0[4];
extern const X8 _4976_3fa4[4];
extern const i8 _4976_3fa8[16];
extern const X8 * const strEndLine;


extern const X8 RuneManaPower[24];
extern const X8 RunePowerMultiplicator[30] ;
...
extern U16	_4976_49e8_ItemHoldMask[13]; //Rr // (_4976_49e8) player item holding mask
extern U8	_4976_4862_MouseCursor[96]; //Rp (_4976_4862)
extern U8	_4976_48c2_CursorHandPointer[128]; //Rp (_4976_48c2)
