...
#define GDAT_INTERFACE_SUBCAT_x00_BASE_DATA					0x00
#define GDAT_INTERFACE_SUBCAT_x02_CHAMPION_TOPSLAB			0x02
#define GDAT_INTERFACE_SUBCAT_x03_MOVE_ARROWS				0x03
#define GDAT_INTERFACE_SUBCAT_x04_CHAMPION					0x04
#define GDAT_INTERFACE_SUBCAT_x05_SPELLMENU					0x05
#define GDAT_INTERFACE_SUBCAT_x06_CHAMPION_FACING			0x06
#define GDAT_INTERFACE_SUBCAT_x07_CHAMPION_AURA				0x07


//------------------------------------------------------------------------------
// SCRIPT EVENTS (expansion)
#define _EXP_SCRIPT__GAME_INIT_					0
#define _EXP_SCRIPT__PLAYER_INIT_				1
#define _EXP_SCRIPT__PLAYER_ON_TILE_			2
#define _EXP_SCRIPT__PLAYER_TURN_ON_TILE_		3
#define _EXP_SCRIPT__ANY_EVENT_					4

//------------------------------------------------------------------------------
// SPECIAL MENU GLOBAL SCREEN
#define _MENU_SCREEN__TITLE_MENU				0x63
#define _MENU_SCREEN__RESUME_GAME_SELECT		0x00
#define _MENU_SCREEN__LOAD_NEW_GAME				0x01
#define _MENU_SCREEN__SHOW_CREDITS				0xDA
...
#define C02_INVENTORY_HEAD					2
#define C03_INVENTORY_BODY					3	
#define C04_INVENTORY_LEGS					4	
#define C05_INVENTORY_FOOT					5
	#define C05_INVENTORY_BODYPART_LAST			5	

#define C06_INVENTORY_POUCH_2				6
#define C07_INVENTORY_SCABBARD_2			7		
#define C08_INVENTORY_SCABBARD_3			8
#define C09_INVENTORY_SCABBARD_4			9
#define C10_INVENTORY_NECK					10
#define C11_INVENTORY_POUCH_1				11
#define C12_INVENTORY_SCABBARD_1			12
#define C13_INVENTORY_BACKPACK_1			13
#define C29_INVENTORY_BACKPACK_17			29
	#define C29_INVENTORY_BACKPACK_LAST		C29_INVENTORY_BACKPACK_17		

#define C30_INVENTORY_MAX_SLOT				30		// 0x1E

// Extra slots are for containers (chests, bags, quivers ...)
#define C30_INVENTORY_OVER_1			30		// 0x1E
#define C31_INVENTORY_OVER_2			31
#define C32_INVENTORY_OVER_3			32
#define C33_INVENTORY_OVER_4			33
#define C34_INVENTORY_OVER_5			34
#define C35_INVENTORY_OVER_6			35
#define C36_INVENTORY_OVER_7			36
#define C37_INVENTORY_OVER_8			37

	#define C38_INVENTORY_MAX_OVER			38		// 0x26
...
// Enchantments types
#define C00_ENCHANTMENT_FIRE_SHIELD			0
#define C01_ENCHANTMENT_SPELL_SHIELD		1
#define C02_ENCHANTMENT_PARTY_SHIELD		2

#define C03_ENCHANTMENT_AURA_STRENGTH		3
#define C04_ENCHANTMENT_AURA_DEXTERITY		4
#define C05_ENCHANTMENT_AURA_WISDOM			5
#define C06_ENCHANTMENT_AURA_VITALITY		6

#define C03_ENCHANTMENT_AURA_FIRST			C03_ENCHANTMENT_AURA_STRENGTH
#define C06_ENCHANTMENT_AURA_LAST			C06_ENCHANTMENT_AURA_VITALITY
...
#define SOUND_STD_INTERWALL_DOOR		0x03	// SPX: CUSTOM, interwall door open/close sound
...
#define SOUND_WALL_CLOSE				0x9E	// SPX: CUSTOM, when a floor tile is turned into a wall tile, or a trickwall is closed
#define SOUND_WALL_OPEN					0x9F	// SPX: CUSTOM, when a wall tile is opened into a floor tile, or a trickwall is opened
...
#define GDAT_INTERFACE_CANCEL_BUTTON				0x0B
#define GDAT_INTERFACE_CANCEL_BUTTON_PUSHED			0x0C
#define GDAT_INTERFACE_SLEEP_BUTTON					0x0D		// zzz
#define GDAT_INTERFACE_SLEEP_BUTTON_PUSHED			0x0E
#define GDAT_INTERFACE_DISK_BUTTON					0x0F
#define GDAT_INTERFACE_DISK_BUTTON_PUSHED			0x10
#define GDAT_INTERFACE_SOUND_BUTTON					0x11
#define GDAT_INTERFACE_SOUND_BUTTON_PUSHED			0x12
#define GDAT_INTERFACE_CHARNAME_BAR					0x13
#define GDAT_INTERFACE_CHARNAME_BAR_ACTIVE			0x14

#define GDAT_INTERFACE_CHAR_EYE						0x20
#define GDAT_INTERFACE_CHAR_EYE_ACTIVE				0x21

#define GDAT_INTERFACE_CHAR_MOUTH_OPEN				0x24
#define GDAT_INTERFACE_CHAR_MOUTH_NEUTRAL			0x25
#define GDAT_INTERFACE_CHAR_MOUTH_CLOSED			0x26

#define GDAT_INTERFACE_BODY_HAND_LEFT				0x34
#define GDAT_INTERFACE_BODY_HAND_RIGHT				0x38


#define GDAT_x00_CHAMPION_SLAB_HANDS			0x00
#define GDAT_x01_CHAMPION_SLAB_DEAD				0x01
#define GDAT_x09_CHAMPION_SLAB_PORTRAIT			0x09

#define GDAT_x04_CHAR_ICON_SLAB_GREY			0x04
#define GDAT_x05_CHAR_ICON_SLAB_RED_FRAME		0x05
#define GDAT_x06_CHAR_ICON_SLAB_BLUE_READY		0x06
...
#define GDAT_x02_MOVE_ARROW__TURN_LEFT				0x02
	#define GDAT_x02_MOVE_ARROW__FIRST				GDAT_x02_MOVE_ARROW__TURN_LEFT
#define GDAT_x03_MOVE_ARROW__TURN_LEFT_PUSHED		0x03
#define GDAT_x04_MOVE_ARROW__TURN_RIGHT				0x04
#define GDAT_x05_MOVE_ARROW__TURN_RIGHT_PUSHED		0x05
#define GDAT_x06_MOVE_ARROW__AHEAD					0x06
#define GDAT_x07_MOVE_ARROW__AHEAD_PUSHED			0x07
#define GDAT_x08_MOVE_ARROW__RIGHT					0x08
#define GDAT_x09_MOVE_ARROW__RIGHT_PUSHED			0x09
#define GDAT_x0A_MOVE_ARROW__BACKWARDS				0x0A
#define GDAT_x0B_MOVE_ARROW__BACKWARDS_PUSHED		0x0B
#define GDAT_x0C_MOVE_ARROW__LEFT					0x0C
#define GDAT_x0D_MOVE_ARROW__LEFT_PUSHED			0x0D

#define GDAT_x0E_PUSH_ARROW__TURN_LEFT				0x0E
	#define GDAT_x0E_PUSH_ARROW__FIRST				GDAT_x0E_PUSH_ARROW__TURN_LEFT
#define GDAT_x0F_PUSH_ARROW__TURN_LEFT_PUSHED		0x03
#define GDAT_x10_PUSH_ARROW__TURN_RIGHT				0x04
#define GDAT_x11_PUSH_ARROW__TURN_RIGHT_PUSHED		0x05
#define GDAT_x12_PUSH_ARROW__AHEAD					0x06
#define GDAT_x13_PUSH_ARROW__AHEAD_PUSHED			0x07
#define GDAT_x14_PUSH_ARROW__RIGHT					0x08
#define GDAT_x15_PUSH_ARROW__RIGHT_PUSHED			0x09
#define GDAT_x16_PUSH_ARROW__BACKWARDS				0x0A
#define GDAT_x17_PUSH_ARROW__BACKWARDS_PUSHED		0x0B
#define GDAT_x18_PUSH_ARROW__LEFT					0x0C
#define GDAT_x19_PUSH_ARROW__LEFT_PUSHED			0x0D



#define GDAT_x08_RUNE_CELL__PUSHED					0x08
...
#define GDAT_GFXSET_WALL_D0_L						0x23
#define GDAT_GFXSET_WALL_D0_R						0x24
#define GDAT_GFXSET_WALL_D0_FRONT					0x25

#define GDAT_GFXSET_WALL_D1_L						0x26
#define GDAT_GFXSET_WALL_D1_R						0x27
#define GDAT_GFXSET_WALL_D1_FRONT					0x28

#define GDAT_GFXSET_WALL_D2_L						0x29
#define GDAT_GFXSET_WALL_D2_R						0x2A

// 0x2B
// 0x2C
#define GDAT_GFXSET_WALL_D2_FRONT					0x2D

#define GDAT_GFXSET_WALL_D3_L						0x2E
#define GDAT_GFXSET_WALL_D3_R						0x2F
#define GDAT_GFXSET_WALL_D3_L2						0x30
#define GDAT_GFXSET_WALL_D3_R2						0x31
...
#define GDAT_GFXSET_STAIRS_FRONT_UP_D1				0x3E
#define GDAT_GFXSET_STAIRS_FRONT_UP_D1_ASIDE		0x3F

#define GDAT_GFXSET_STAIRS_FRONT_UP_D2				0x41
#define GDAT_GFXSET_STAIRS_FRONT_UP_D2_ASIDE		0x42	// towards right
...
#define GDAT_GFXSET_STAIRS_FRONT_DOWN_D1			0x52
#define GDAT_GFXSET_STAIRS_FRONT_DOWN_D1_ASIDE		0x53

#define GDAT_GFXSET_STAIRS_FRONT_DOWN_D2			0x55
#define GDAT_GFXSET_STAIRS_FRONT_DOWN_D2_ASIDE		0x56	// towards right

#define GDAT_GFXSET_STAIRS_FRONT_DOWN_D2_ASIDE_FAR	0x58
...
#define DRAW_DOOR_FLAG_RIGHT_FRAME			0x04
...
#define TIMER_NONE						0xFFFF
	...
	#define MAX_TIMER_NUMBER					500 //15000
#else
...
// UI Event code
#define UI_EVENTCODE_x00_NONE		0x00

#define UI_EVENTCODE_x01_TURN_LEFT	0x01
#define UI_EVENTCODE_x02_TURN_RIGHT	0x02

#define UI_EVENTCODE_x03_MOVE_FORWARD	0x03
#define UI_EVENTCODE_x04_MOVE_RIGHT		0x04
#define UI_EVENTCODE_x05_MOVE_BACK		0x05
#define UI_EVENTCODE_x06_MOVE_LEFT		0x06
	#define UI_EVENTCODE_x03_MOVE_FIRST	UI_EVENTCODE_x03_MOVE_FORWARD
	#define UI_EVENTCODE_x06_MOVE_LAST	UI_EVENTCODE_x06_MOVE_LEFT

#define UI_EVENTCODE_x01_ARROW_DIR_FIRST	UI_EVENTCODE_x01_TURN_LEFT
#define UI_EVENTCODE_x06_ARROW_DIR_LAST		UI_EVENTCODE_x06_MOVE_LEFT


#define UI_EVENTCODE_x07_VIEW_CHAMPION_1	0x07
#define UI_EVENTCODE_x08_VIEW_CHAMPION_2	0x08
#define UI_EVENTCODE_x09_VIEW_CHAMPION_3	0x09
#define UI_EVENTCODE_x0A_VIEW_CHAMPION_4	0x0A
#define UI_EVENTCODE_x0B_RETURN_VIEWPORT	0x0B

#define UI_EVENTCODE_x10	0x10
#define UI_EVENTCODE_x11	0x11
#define UI_EVENTCODE_x12	0x12
#define UI_EVENTCODE_x13	0x13


#define UI_EVENTCODE_x14_ITEM_SLOT_FIRST			0x14

#define UI_EVENTCODE_x14_CHAMPION_1_HAND_RIGHT		0x14
#define UI_EVENTCODE_x15_CHAMPION_1_HAND_LEFT		0x15
#define UI_EVENTCODE_x16_CHAMPION_2_HAND_RIGHT		0x16
#define UI_EVENTCODE_x17_CHAMPION_2_HAND_LEFT		0x17
#define UI_EVENTCODE_x18_CHAMPION_3_HAND_RIGHT		0x18
#define UI_EVENTCODE_x19_CHAMPION_3_HAND_LEFT		0x19
#define UI_EVENTCODE_x1A_CHAMPION_4_HAND_RIGHT		0x1A
#define UI_EVENTCODE_x1B_CHAMPION_4_HAND_LEFT		0x1B

#define UI_EVENTCODE_x1C_INVENTORY_HAND_RIGHT		0x1C
#define UI_EVENTCODE_x1D_INVENTORY_HAND_LEFT		0x1D

#define UI_EVENTCODE_x1E_INVENTORY_HEAD		0x1E
#define UI_EVENTCODE_x1F_INVENTORY_BODY		0x1F
#define UI_EVENTCODE_x20_INVENTORY_LEGS		0x20
#define UI_EVENTCODE_x21_INVENTORY_FOOT		0x21

#define UI_EVENTCODE_x22_INVENTORY_POUCH_2		0x22

#define UI_EVENTCODE_x23_INVENTORY_SCABBARD_2	0x23
#define UI_EVENTCODE_x24_INVENTORY_SCABBARD_3	0x24
#define UI_EVENTCODE_x25_INVENTORY_SCABBARD_4	0x25

#define UI_EVENTCODE_x26_INVENTORY_NECK			0x26
#define UI_EVENTCODE_x27_INVENTORY_POUCH_1		0x27
#define UI_EVENTCODE_x28_INVENTORY_SCABBARD_1	0x28

#define UI_EVENTCODE_x29_BACKPACK_01	0x29
#define UI_EVENTCODE_x29_BACKPACK_FIRST	UI_EVENTCODE_BACKPACK_01
#define UI_EVENTCODE_x2A_BACKPACK_02	0x2A
#define UI_EVENTCODE_x2B_BACKPACK_03	0x2B
#define UI_EVENTCODE_x2C_BACKPACK_04	0x2C
#define UI_EVENTCODE_x2D_BACKPACK_05	0x2D
#define UI_EVENTCODE_x2E_BACKPACK_06	0x2E
#define UI_EVENTCODE_x2F_BACKPACK_07	0x2F
#define UI_EVENTCODE_x30_BACKPACK_08	0x30
#define UI_EVENTCODE_x31_BACKPACK_09	0x31
#define UI_EVENTCODE_x32_BACKPACK_10	0x32
#define UI_EVENTCODE_x33_BACKPACK_11	0x33
#define UI_EVENTCODE_x34_BACKPACK_12	0x34
#define UI_EVENTCODE_x35_BACKPACK_13	0x35
#define UI_EVENTCODE_x36_BACKPACK_14	0x36
#define UI_EVENTCODE_x37_BACKPACK_15	0x37
#define UI_EVENTCODE_x38_BACKPACK_16	0x38
#define UI_EVENTCODE_x39_BACKPACK_17	0x39
#define UI_EVENTCODE_x39_BACKPACK_LAST	UI_EVENTCODE_BACKPACK_17

#define UI_EVENTCODE_x3A_CONTAINER_1	0x3A
#define UI_EVENTCODE_x3B_CONTAINER_2	0x3B
#define UI_EVENTCODE_x3C_CONTAINER_3	0x3C
#define UI_EVENTCODE_x3D_CONTAINER_4	0x3D
#define UI_EVENTCODE_x3E_CONTAINER_5	0x3E
#define UI_EVENTCODE_x3F_CONTAINER_6	0x3F
#define UI_EVENTCODE_x40_CONTAINER_7	0x40
#define UI_EVENTCODE_x41_CONTAINER_8	0x41

#define UI_EVENTCODE_x42	0x42

#define UI_EVENTCODE_x42_ITEM_SLOT_LAST	0x42


#define UI_EVENTCODE_x46_MOUTH	0x46
#define UI_EVENTCODE_x47_EYE	0x47

#define UI_EVENTCODE_x50_CLICK_VIEWPORT	0x50

#define UI_EVENTCODE_x52_VIEW_LEADER	0x52

#define UI_EVENTCODE_x5D_CHAMPION_TURN_LEFT		0x5D
#define UI_EVENTCODE_x5E_CHAMPION_TURN_RIGHT	0x5E

#define UI_EVENTCODE_x5F_SPELL_OR_LEADER_1	0x5F	// For choosing leader and invoking spell panel / TOP LEFT
#define UI_EVENTCODE_x60_SPELL_OR_LEADER_2	0x60	// TOP RIGHT
#define UI_EVENTCODE_x61_SPELL_OR_LEADER_3	0x61	// BOTTOM RIGHT
#define UI_EVENTCODE_x62_SPELL_OR_LEADER_4	0x62	// BOTTOM LEFT

#define UI_EVENTCODE_x65_ADD_RUNE_1		0x65
#define UI_EVENTCODE_x66_ADD_RUNE_2		0x66
#define UI_EVENTCODE_x67_ADD_RUNE_3		0x67
#define UI_EVENTCODE_x68_ADD_RUNE_4		0x68
#define UI_EVENTCODE_x69_ADD_RUNE_5		0x69
#define UI_EVENTCODE_x6A_ADD_RUNE_6		0x6A

#define UI_EVENTCODE_x6B_REMOVE_RUNE		0x6B
#define UI_EVENTCODE_x6C_VALIDATE_SPELL		0x6C


#define UI_EVENTCODE_x70_HAND_RUNE_QUIT		0x70	// Cancel action for HAND or Leave rune panel (do not destroy spell)

#define UI_EVENTCODE_x71_HAND_ACTION_1		0x71
#define UI_EVENTCODE_x72_HAND_ACTION_2		0x72
#define UI_EVENTCODE_x73_HAND_ACTION_3		0x73


#define UI_EVENTCODE_x74_CHAMPION1_ACTION_HAND_RIGHT	0x74
#define UI_EVENTCODE_x75_CHAMPION1_ACTION_HAND_LEFT		0x75
#define UI_EVENTCODE_x76_CHAMPION2_ACTION_HAND_RIGHT	0x76
#define UI_EVENTCODE_x77_CHAMPION2_ACTION_HAND_LEFT		0x77
#define UI_EVENTCODE_x78_CHAMPION3_ACTION_HAND_RIGHT	0x78
#define UI_EVENTCODE_x79_CHAMPION3_ACTION_HAND_LEFT		0x79
#define UI_EVENTCODE_x7A_CHAMPION4_ACTION_HAND_RIGHT	0x7A
#define UI_EVENTCODE_x7B_CHAMPION4_ACTION_HAND_LEFT		0x7B

#define UI_EVENTCODE_x7D_TAKE_CHAMPION_TOP_LEFT		0x7D
#define UI_EVENTCODE_x7E_TAKE_CHAMPION_TOP_RIGHT	0x7E
#define UI_EVENTCODE_x7F_TAKE_CHAMPION_BOTTOM_RIGHT	0x7F
#define UI_EVENTCODE_x80_TAKE_CHAMPION_BOTTOM_LEFT	0x80
#define UI_EVENTCODE_x81_UPDATE_CHAMPION_POSITION	0x81

#define UI_EVENTCODE_x8C_DISK_OP		0x8C

#define UI_EVENTCODE_x91_SLEEP			0x91	// Put into sleep
#define UI_EVENTCODE_x92_WAKE			0x92	// Wake from sleep
#define UI_EVENTCODE_x93_PAUSE			0x93	// Invoke game pause
#define UI_EVENTCODE_x94_END_PAUSE		0x94	// Resume from pause

#define UI_EVENTCODE_x96_MAGIC_MAP			0x96

#define UI_EVENTCODE_x97_MAGIC_MAP_RUNE_1	0x97	// Rune 1 : KU for creatures
#define UI_EVENTCODE_x98_MAGIC_MAP_RUNE_2	0x98	// Rune 2 : ROS for illusionary walls
#define UI_EVENTCODE_x99_MAGIC_MAP_RUNE_3	0x99	// Rune 3 : DAIN for spells
#define UI_EVENTCODE_x9A_MAGIC_MAP_RUNE_4	0x9A	// Rune 4 : NETA for ... what ?


#define UI_EVENTCODE_xA0_REVIVE_CHAMPION	0xA0	// (160)
#define UI_EVENTCODE_xA1_EXIT_CRYOCELL		0xA1	// (161) Exit champion-to-be-revived inventory 

#define UI_EVENTCODE_xA5				0xA5
#define UI_EVENTCODE_xC6				0xC6
#define UI_EVENTCODE_xD6				0xD6

#define UI_EVENTCODE_xD7_START_NEW_GAME		0xD7

#define UI_EVENTCODE_xD8_LOAD_GAME			0xD8

#define UI_EVENTCODE_xD9_RESUME_GAME		0xD9	// Resume from main menu

#define UI_EVENTCODE_xDA_SHOW_CREDITS		0xDA

#define UI_EVENTCODE_xDB_DIALOG_BUTTON_1	0xDB	// OK, CANCEL Buttons ... depends on DIALOG structure
#define UI_EVENTCODE_xDC_DIALOG_BUTTON_2	0xDC	// 
#define UI_EVENTCODE_xDD_DIALOG_BUTTON_3	0xDD	//
#define UI_EVENTCODE_xDE_DIALOG_BUTTON_4	0xDE	// NOT VERIFIED

#define UI_EVENTCODE_xDF				0xDF

#define UI_EVENTCODE_xE0_QUIT_GAME			0xE0

#define UI_EVENTCODE_xE1_MOVE_OBJECT		0xE1	// Like move a table around ..

#define UI_EVENTCODE_xE3_RELEASE_MOUSE_BUTTON	0xE3

#define UI_EVENTCODE_xE4_MONEYBOX_1	0xE4
#define UI_EVENTCODE_xE5_MONEYBOX_2	0xE5
#define UI_EVENTCODE_xE6_MONEYBOX_3	0xE6
#define UI_EVENTCODE_xE7_MONEYBOX_4	0xE7
#define UI_EVENTCODE_xE8_MONEYBOX_5	0xE8
#define UI_EVENTCODE_xE9_MONEYBOX_6	0xE9


#define UI_EVENTCODE_xEA_CLICK_STATS_BAR_1	0xEA	// Clicking on stats bar with item will place it in inventory!
#define UI_EVENTCODE_xEB_CLICK_STATS_BAR_2	0xEB
#define UI_EVENTCODE_xEC_CLICK_STATS_BAR_3	0xEC
#define UI_EVENTCODE_xED_CLICK_STATS_BAR_4	0xED

#define UI_EVENTCODE_xEF_QUIT_CREDITS	0xEF

#define UI_EVENTCODE_xEF_LAST_EVENT		0xEF
...
#define ACTUATOR_TYPE_DM1_ALCOVE_ITEM					0x02	// 02	was unimplemented in DM2
...
#define ACTUATOR_TYPE_CREATURE_KILLER					0x0B	// 11	SPX: added for convenience
...
//
#define TILE_FLAG_HAS_OBJECT			1
#define TILE_FLAG_IS_OPEN				2
#define TILE_FLAG_IS_CLOSED				3
#define TILE_FLAG_IS_ILLUSIONARY		4
#define TILE_FLAG_IS_NORTH_SOUTH		5
#define TILE_FLAG_IS_WEST_EAST			6
#define TILE_FLAG_IS_LEADING_UP			7	// stairs
#define TILE_FLAG_IS_LEADING_DOWN		8	// stairs
#define TILE_FLAG_HAS_HAZE				7	// teleporter
...
#define RECT_040_PANEL_ARROW__TURN_LEFT				40	// 0x28
	#define RECT_040_PANEL_ARROW__FIRST				RECT_040_PANEL_ARROW__TURN_LEFT
#define RECT_041_PANEL_ARROW__TURN_RIGHT			41	// 0x29
#define RECT_042_PANEL_ARROW__AHEAD					42	// 0x2A
#define RECT_043_PANEL_ARROW__RIGHT					43	// 0x2B
#define RECT_044_PANEL_ARROW__BACKWARDS				44	// 0x2C
...
#define RECT_177_CHAMPION_NAME_BOX_1				177
