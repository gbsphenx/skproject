...
static bool DM2_HANDLE_UI_EVENT(c_uievent* eaxp)
{
     ...
     )
  {
    ...
    else if (idx == 82) //m_120F6:
    {
      ...
      ddat.v1e0488 = DM2_TRY_CAST_SPELL();
      ...
      ddat.v1e0488 = DM2_PROCEED_COMMAND_SLOT(idx - 113);
  ...
  for (;;)
  {
    ...
    if (c <= 16)
    {
      ...
      switch (c)
      {
        ...
        case 6:
          //m_114F8:
          eu = eventqueue.event_unk04 + 1;
          if (eu > 2)
            eu = 0;
          if (eu != eventqueue.event_unk03)
          {
            //m_11530:
            eventdata.table1e04e0[eventqueue.event_unk04] = eventdata.v1e04d2;
            eventqueue.event_unk04 = eu;
            if ((vb_44 & 0x3f) != 0x4)
              skip00188 = true;
          }
          else
      ...
      {
        //m_11568:
        eventqueue.event_unk02 = eventqueue.event_unk04 - eventqueue.event_unk03;
        if (eventqueue.event_unk02 < 0)
...
{
  if (ddat.v1e0526 != 0)
    ddat.v1e0526 = ddat.v1e0526 - 1;
  ddat.v1e0478 = 0;
  //m_1257C:
  for (;;)
  {
    DM2_IBMIO_USER_INPUT_CHECK();
    if (eventqueue.event_unk03 == eventqueue.event_unk04)
      return;
    i16 e = eventqueue.event_unk03++;

    if (eventqueue.event_unk03 > 2)
      eventqueue.event_unk03 = 0;
    if (!DM2_HANDLE_UI_EVENT(eventdata.table1e04e0 + e))
      //m_125E0:
      eventqueue.event_unk03 = e;
