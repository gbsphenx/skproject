...
// #################################################################
  ...
  class c_dm2data
  {
    public:
     ...
     unk* v1e1038;
     i16* v1e09a0;
     c_pixel* v1e0950; // 1st palette
     c_pixel* v1e0954; // 2nd palette
     unk* v1e03f0;
     i16* v1e03e4;
     unk* v1e03dc;
     i8* v1e03d4;
...
#define v1d64d3 (vsgame + 0x70)
  ...
  extern const i8 table1d6c5e[9];
  extern const i8 table1d6c67[9];
  extern const i8 table1d6c06[5];
