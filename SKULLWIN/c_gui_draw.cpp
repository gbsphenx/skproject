...
{
  DM2_DRAW_ICON_PICT_ENTRY(1, 4, 20, &dm2_buttongroup2, lcon(0x3c));
  DM2_DRAW_ICON_PICT_ENTRY(1, 4, 14, &dm2_buttongroup2, lcon(0x3b));
...
void DM2_DRAW_PLAYER_DAMAGE(i32 eaxl)
{
  ...
  put16(parw00, RG5W);
  DM2_DRAW_ICON_PICT_ENTRY(1, 2, 3, &dm2_buttongroup1, parw00, ALPHA_A);
...
void DM2_DRAW_PLAYER_3STAT_PANE(i32 eaxl, i32 edxl)
{
  ...
  put16(parw00, RG3W);
  DM2_DRAW_ICON_PICT_ENTRY(1, 2, vb_00, &dm2_buttongroup1, parw00);
  if (RG5l == 0)
...
void DM2_DRAW_CMD_SLOT(i16 eaxw, i8 edxb)
{
  ...
  DM2_DRAW_ICON_PICT_ENTRY(1, 4, edxb + 21, &dm2_buttongroup2, eaxw + wcon(0x3f));
...
void DM2_DRAW_SPELL_TO_BE_CAST(i32 eaxl)
{
  ...
  DM2_guidraw_29ee_00a3(0);
  if (eaxl != 0)
    DM2_DRAW_ICON_PICT_ENTRY(1, 5, 9, &dm2_buttongroup2, lcon(0xfc));
...
void DM2_DRAW_PLAYER_ATTACK_DIR(void)
{
  ...
  DM2_DRAW_ICON_PICT_ENTRY(1, 4, 16, &dm2_buttongroup2, lcon(0x60));
  DM2_DRAW_ICON_PICT_ENTRY(1, 4, 18, &dm2_buttongroup2, lcon(0x61));
}
...
void DM2_DRAW_SPELL_PANEL(void)
{
  ...
  RG2L = unsignedlong(RG1Blo);
  DM2_DRAW_ICON_PICT_ENTRY(1, 5, RG2Blo, &dm2_buttongroup2, lcon(0x5c));
...
void DM2_DRAW_HAND_ACTION_ICONS(i16 eaxw, i32 edxl, i32 ebxl)
{
  ...
  RG2L = unsignedlong(RG1Blo);
  DM2_DRAW_ICON_PICT_ENTRY(1, 4, RG2Blo, &dm2_buttongroup2, parw00);
...
void DM2_HIGHLIGHT_ARROW_PANEL(i32 eaxl, i32 edxl, i32 ebxl)
{
  ...
  put16(parw00, RG5W);
  RG2L = unsignedlong(RG3Blo);
  DM2_DRAW_ICON_PICT_ENTRY(1, 3, RG2Blo, &buttongroup, parw00);
...
i32 DM2_guidraw_29ee_000f(void)
{
  ...
  {
    //m_32BE8:
    DM2_DRAW_ICON_PICT_ENTRY(1, 3, vb_34, &buttongroup, i);
    vb_34 += 2;
  }
  DM2_gfxmain_0b36_0cbe(&buttongroup, true);
  if (ddat.v1e03a8 == 0)
