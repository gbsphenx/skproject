// EdTileTeleDlg.cpp : インプリメンテーション ファイル
//
...
/////////////////////////////////////////////////////////////////////////////
// CEdTileTeleDlg ダイアログ


CEdTileTeleDlg::CEdTileTeleDlg(CWnd* pParent /*=NULL*/)
	: CEdTileDlg(CEdTileTeleDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CEdTileTeleDlg)
	m_fSw1 = FALSE;
	m_fSw2 = FALSE;
	m_fSw3 = FALSE;
	m_fSw4 = FALSE;
...
void CEdTileTeleDlg::DoDataExchange(CDataExchange* pDX)
{
	CEdTileDlg::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CEdTileTeleDlg)
...
BEGIN_MESSAGE_MAP(CEdTileTeleDlg, CEdTileDlg)
	//{{AFX_MSG_MAP(CEdTileTeleDlg)
	//}}AFX_MSG_MAP
	ON_CONTROL_RANGE(BN_CLICKED, IDC_CHECK_SW1, IDC_RADIO_OP8, OnCheckSw1)
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CEdTileTeleDlg メッセージ ハンドラ

void CEdTileTeleDlg::OnCheckSw1(UINT nID) 
{
...
BOOL CEdTileTeleDlg::OnInitDialog() 
{
