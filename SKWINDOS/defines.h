...
#define GDAT_CREATURE_ANIM_ATTRIBUTION		0xFB	// ATTR
#define GDAT_CREATURE_ANIM_INFO_SEQUENCE	0xFC	// INFO
#define GDAT_CREATURE_ANIM_FRAME_SEQUENCE	0xFD	// FRAM
#define GDAT_CREATURE_ANIM_SCALE_GROUPS		0xFE	// SCAL
